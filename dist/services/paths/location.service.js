...
class LocationService {
    ...
    getLocations() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.locationRepository.findAll();
            }
            catch (error) {
    ...
    getLocation(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.locationRepository.findById(id);
            }
            catch (error) {
    ...
    createLocation(businessData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.locationRepository.create(businessData);
            }
            catch (error) {
    ...
    updateLocation(id, businessData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.locationRepository.update(id, businessData);
            }
            catch (error) {
